...
describe("config - multi-personality", () => {
  ...
  describe("listPersonalities", () => {
    ...
    it("should list global personalities", () => {
      ...
      fs.writeFileSync(
        path.join(globalPersonalitiesDir, "global-personality.json"),
    ...
    it("should list project personalities", () => {
      ...
      fs.writeFileSync(
        path.join(projectPersonalitiesDir, "project-personality.json"),
        JSON.stringify(personality)
      )
    ...
    it("should merge personalities from both scopes", () => {
      ...
      fs.writeFileSync(
        path.join(globalPersonalitiesDir, "global-one.json"),
        JSON.stringify(globalPersonality)
      )
      fs.writeFileSync(
        path.join(projectPersonalitiesDir, "project-one.json"),
        JSON.stringify(projectPersonality)
      )
    ...
    it("should prefer project personality when names conflict", () => {
      ...
      fs.writeFileSync(
        path.join(globalPersonalitiesDir, "shared.json"),
        JSON.stringify(globalPersonality)
      )
      fs.writeFileSync(
        path.join(projectPersonalitiesDir, "shared.json"),
        JSON.stringify(projectPersonality)
      )
  ...
  describe("loadPersonality", () => {
    ...
    it("should load global personality", () => {
      ...
      fs.writeFileSync(
        path.join(globalPersonalitiesDir, "global-test.json"),
        JSON.stringify(personality)
      )
    ...
    it("should prefer project personality over global", () => {
      ...
      fs.writeFileSync(
        path.join(globalPersonalitiesDir, "test.json"),
        JSON.stringify(globalPersonality)
      )
      fs.writeFileSync(
        path.join(projectPersonalitiesDir, "test.json"),
        JSON.stringify(projectPersonality)
      )
  ...
  describe("deletePersonality", () => {
    it("should delete global personality", () => {
      ...
      fs.writeFileSync(
        path.join(globalPersonalitiesDir, "to-delete.json"),
        JSON.stringify(personality)
      )
    ...
    it("should delete project personality", () => {
      const personality = mockPersonalityFile({ name: "to-delete" })
      fs.writeFileSync(
        path.join(projectPersonalitiesDir, "to-delete.json"),
        JSON.stringify(personality)
      )
